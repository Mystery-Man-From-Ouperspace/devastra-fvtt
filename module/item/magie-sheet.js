 ...
 * @extends {ItemSheet}
 */
export class DEVASTRAMagieSheet extends ItemSheet {
  /** @inheritdoc */
  ...
  async getData(options) {
    ...
    context.magiesubtypes = DEVASTRA.MAGIESUBTYPES
    context.Mandala = this.item.Mandala;
    context.isMantra = this.item.isMantra;
